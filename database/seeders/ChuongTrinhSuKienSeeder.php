    ...
    public function run(): void
    {
        DB::table('chuongtrinhsukien')->insert([
            [
                ...
                'slug' => Str::slug('Tuần Lễ Vàng - Flash Sale 9.9'),
            ...
            [
                ...
                'slug' => Str::slug('Tuần Lễ Vàng - Tuần lễ Vàng'),
            ...
            [
                ...
                'slug' => Str::slug('Tuần Lễ Vàng - Black Friday 2025'),
            ...
            [
                ...
                'slug' => Str::slug('Tuần Lễ Vàng - Mua 1 Tặng 1'),
