    ...
    public function run(): void
    {
        ...
        $data = [
            [
                ...
                'trangthai' => 'hoat_dong',
                'luotxem' => 120,
                'id_cuahang' => 1, // giả lập thương hiệu có id=21 -30
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
            ...
            // sản phẩm ko thuộc của hàng nào
            [
                'ten' => 'Cà phê Trung Nguyên',
                'mota' => 'Cà phê rang xay nguyên chất, hương vị đậm đà.',
                'xuatxu' => 'Việt Nam',
                'sanxuat' => 'Trung Nguyên Legend',
                'trangthai' => 'cho_duyet',
                'luotxem' => 820,
                'id_cuahang' => null,
                'created_at' => $now,
            ...
            [
                'ten' => 'Sữa tươi TH True Milk',
                'mota' => 'Sản phẩm sữa tươi sạch từ trang trại TH.',
                'xuatxu' => 'Việt Nam',
                'sanxuat' => 'TH Group',
                'trangthai' => 'cho_duyet',
                'luotxem' => 940,
