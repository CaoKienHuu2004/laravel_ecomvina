...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::prefix('danhmuc')->group(function () {
        ...
        Route::get('/show/{id}/{slug}', [DanhmucController::class, 'show'])->name('danhmuc.show');
    ...
    Route::prefix('sanpham')->group(function () {
        ...
        Route::get('/create', [SanphamController::class, 'create'])->name('tao-san-pham');
        Route::post('/store', [SanphamController::class, 'save'])->name('luu-san-pham');
        Route::get('/show/{slug}/{id}', [SanphamController::class, 'show'])->name('chi-tiet-san-pham');
        Route::get('/edit/{id}', [SanphamController::class, 'edit'])->name('chinh-sua-san-pham');
        Route::post('/update/{id}', [SanphamController::class, 'update'])->name('cap-nhat-san-pham');
        Route::delete('/delete/{id}', [SanphamController::class, 'destroy'])->name('xoa-san-pham');
