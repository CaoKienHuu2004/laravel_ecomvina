...
Route::middleware([
    ...
    Route::prefix('cua-hang')->group(function () {
        ...
        Route::put('/{id}/cap-nhat-tai-khoan', [CuaHangController::class, 'update'])->name('cap-nhat-cua-hang-tai-khoan');
        Route::put('/{id}/cap-nhat-cua-hang-duyet', [CuaHangController::class, 'update'])->name('cap-nhat-cua-hang-duyet');
        Route::put('/{id}/cap-nhat-trang-thai', [CuaHangController::class, 'update'])->name('cap-nhat-trang-thai');
        Route::put('/{id}/cap-nhat-trang-thai-cua-hang', [CuaHangController::class, 'update'])->name('cap-nhat-trang-thai-cua-hang');
