...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 19, 2025 lúc 05:41 PM
...
CREATE TABLE `bienthe_sp` (
  `id` int(11) NOT NULL,
  `id_tenloai` int(11) DEFAULT NULL,
  `gia` int(11) DEFAULT NULL,
  `soluong` int(11) DEFAULT 0,
  `trangthai` int(11) DEFAULT 0 COMMENT 'trạng thái hiển thị (0 hiển thị; 1 ẩn)',
  `uutien` int(11) DEFAULT 0 COMMENT '1 ưu tiên ',
...
CREATE TABLE `chuongtrinhsukien` (
  `id` int(11) NOT NULL,
  `ten` varchar(255) NOT NULL COMMENT 'Tiêu đề của sự kiện (ví dụ: "Sale Lớn Cuối Năm - Mua 1 Tặng 1").',
  `slug` varchar(255) NOT NULL COMMENT 'Đường dẫn thân thiện để truy cập trang sự kiện (ví dụ: sale-lon-cuoi-nam-mua-1-tang-1).',
  `media` text NOT NULL COMMENT 'Đường dẫn ảnh banner để hiển thị trên popup hoặc đầu trang.',
  `mota` text NOT NULL COMMENT 'Nội dung chính của "bài viết". Đây là nơi bạn dùng trình soạn thảo văn bản (WYSIWYG) để viết chi tiết về ưu đãi, thể lệ, điều kiện.',
...
CREATE TABLE `danh_gia` (
  `id` int(11) NOT NULL,
  `diem` int(11) DEFAULT NULL COMMENT 'điểm đánh giá (5/5)',
  `noidung` mediumtext DEFAULT NULL COMMENT 'Nội dung đánh giá',
  `media` mediumtext DEFAULT NULL,
  `ngaydang` date DEFAULT NULL COMMENT 'ngày đăng đánh giá',
  `trangthai` int(11) DEFAULT NULL COMMENT 'trạng thái hiển thị (0 hiển thị; 1 ẩn)',
  `id_sanpham` int(11) DEFAULT NULL,
...
CREATE TABLE `diachi_nguoidung` (
  ...
  `xaphuong` text NOT NULL,
  `sonha` text NOT NULL,
  `diachi` mediumtext DEFAULT NULL,
  `trangthai` int(11) DEFAULT 1 COMMENT 'kiểu địa chỉ (0 chính ; 1 phụ)',
  `id_nguoidung` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Cấu trúc bảng cho bảng `dieukien_khuyenmai`
--

CREATE TABLE `dieukien_khuyenmai` (
  `id` int(11) NOT NULL,
  `id_khuyenmai` int(11) NOT NULL COMMENT '	Liên kết tới chương trình khuyến mãi.',
  `id_bienthe` int(11) NOT NULL COMMENT 'Sản phẩm điều kiện (liên kết tới bảng san_pham).',
  `soluongyeucau` int(11) NOT NULL DEFAULT 1 COMMENT 'Số lượng yêu cầu của sản phẩm này. Ví dụ: cần mua 2 cái áo sơ mi.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `dieukien_magiamgia`
--

CREATE TABLE `dieukien_magiamgia` (
  `id` int(11) NOT NULL,
  `loaidieukien` varchar(255) NOT NULL COMMENT 'Loại điều kiện. Đây là cột quan trọng nhất. Ví dụ: user_group, user_is_new, usage_limit_per_user.',
  `sosanh` varchar(255) NOT NULL COMMENT 'Toán tử so sánh. Ví dụ: eq (bằng), gte (lớn hơn hoặc bằng), lt (nhỏ hơn).',
  `giatri` varchar(255) NOT NULL COMMENT 'Giá trị của điều kiện. Ví dụ: 1 (cho nhóm VIP), true, 1 (cho giới hạn 1 lần).',
...
CREATE TABLE `don_hang` (
  ...
  `trangthai` int(11) DEFAULT 0 COMMENT 'trạng thái đơn hàng (0 chờ thanh toán ; 1 đang giao ; 2 đã giao; 3 đã hủy)',
  `id_nguoidung` int(11) DEFAULT NULL,
...
INSERT INTO `don_hang` (`id`, `ma_donhang`, `tongtien`, `tongsoluong`, `ghichu`, `ngaytao`, `trangthai`, `id_nguoidung`, `id_magiamgia`) VALUES
(41, 'DH001', 450000, 5, 'Đặt 5 lọ Nước Yến sào Nest100 - Có đường (70ml)', '2025-09-19 10:00:00', 0, 1, 5),
(42, 'DH002', 500000, 10, 'Đặt 10 hộp Cà Phê Sâm Canada (Hộp 30 gói)', '2025-09-19 12:15:00', 1, 1, 4),
(43, 'DH003', 300000, 5, 'Đặt 5 Viên uống hỗ trợ giảm cân Goraka Slimming', '2025-09-19 14:30:00', 2, 1, 2),
(44, 'DH004', 900000, 3, 'Đặt 3 Máy xay nấu đa năng Olivo CB1000', '2025-09-19 16:00:00', 3, 1, 2),
(45, 'DH005', 350000, 10, 'Đặt 10 hộp Cà phê bào tử Linh Chi phá vách', '2025-09-19 18:45:00', 0, 1, 3);
...
CREATE TABLE `khuyenmai` (
  `id` int(11) NOT NULL,
  `ten` varchar(255) NOT NULL COMMENT 'Tên chương trình (ví dụ: "Chào hè sang, mua 2 tặng 1", "Tri ân khách hàng tháng 10").',
...
--
-- Cấu trúc bảng cho bảng `lichsu_magiamgia`
--
...
CREATE TABLE `ma_giamgia` (
  ...
  `loaigiamgia` enum('percent','fixed') DEFAULT NULL COMMENT 'Loại giảm giá. percent là giảm theo phần trăm, fixed là giảm một số tiền cố định.',
  ...
  `soluong` int(11) DEFAULT NULL COMMENT 'Tổng số lượt sử dụng của voucher này.',
  `luotsudung` int(11) NOT NULL DEFAULT 0 COMMENT 'Số lượt đã sử dụng. Khi used_count bằng quantity, voucher sẽ hết hiệu lực.',
...
INSERT INTO `ma_giamgia` (`id`, `magiamgia`, `mota`, `loaigiamgia`, `giatri`, `mindonhang`, `soluong`, `luotsudung`, `ngaybatdau`, `ngayketthuc`, `trangthai`, `created_at`, `updated_at`) VALUES
(2, 'GG01', 'Giảm giá 10% cho đơn hàng từ 200k trở lên', 'percent', 10, 200000, 100, 0, '2025-09-01', '2025-09-30', 1, '2025-09-19 15:28:01', '0000-00-00 00:00:00'),
(3, 'GG02', 'Giảm 50k cho đơn hàng từ 500k trở lên', 'fixed', 50000, 500000, 50, 0, '2025-09-01', '2025-09-30', 1, '2025-09-19 15:28:01', '0000-00-00 00:00:00'),
(4, 'GG03', 'Giảm 15% cho sản phẩm của thương hiệu XYZ', 'percent', 15, 100000, 50, 0, '2025-09-01', '2025-09-30', 1, '2025-09-19 15:28:01', '0000-00-00 00:00:00'),
(5, 'GG04', 'Giảm 100k cho đơn hàng từ 1 triệu trở lên', 'fixed', 100000, 1000000, 20, 0, '2025-09-01', '2025-09-30', 1, '2025-09-19 15:28:01', '0000-00-00 00:00:00'),
(6, 'GG05', 'Giảm giá 5% cho tất cả sản phẩm', 'percent', 5, 0, 200, 0, '2025-09-01', '2025-09-30', 1, '2025-09-19 15:28:01', '0000-00-00 00:00:00');
...
CREATE TABLE `quatang_khuyenmai` (
  ...
  `id_bienthe` int(11) NOT NULL COMMENT 'Sản phẩm được tặng (liên kết tới bảng san_pham).',
  `soluong` int(11) NOT NULL DEFAULT 1 COMMENT 'Số lượng được tặng của sản phẩm này.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Cấu trúc bảng cho bảng `uudaithanhvien`
--

CREATE TABLE `uudaithanhvien` (
  `id` int(11) NOT NULL,
  `hanmuc` text DEFAULT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `uudaithanhvien`
--
...
--
-- Chỉ mục cho bảng `dieukien_khuyenmai`
--
...
--
-- Chỉ mục cho bảng `dieukien_magiamgia`
--
...
--
-- Chỉ mục cho bảng `lichsu_magiamgia`
--
...
--
-- Chỉ mục cho bảng `uudaithanhvien`
--
...
--
-- AUTO_INCREMENT cho bảng `dieukien_magiamgia`
--
ALTER TABLE `dieukien_magiamgia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `uudaithanhvien`
--
ALTER TABLE `uudaithanhvien`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `anh_sanpham`
  ADD CONSTRAINT `sanpham_anh` FOREIGN KEY (`id_sanpham`) REFERENCES `san_pham` (`id`);

--
-- Các ràng buộc cho bảng `bienthe_sp`
--
ALTER TABLE `bienthe_sp`
  ADD CONSTRAINT `loai_bienthe` FOREIGN KEY (`id_tenloai`) REFERENCES `loai_bienthe` (`id`),
  ADD CONSTRAINT `sanpham_bienthe` FOREIGN KEY (`id_sanpham`) REFERENCES `san_pham` (`id`);

--
-- Các ràng buộc cho bảng `chitiet_donhang`
--
ALTER TABLE `chitiet_donhang`
  ADD CONSTRAINT `bienthe_chitietdonhang` FOREIGN KEY (`id_bienthe`) REFERENCES `bienthe_sp` (`id`),
  ADD CONSTRAINT `donhang_chitietdonhang` FOREIGN KEY (`id_donhang`) REFERENCES `don_hang` (`id`);

--
-- Các ràng buộc cho bảng `danh_gia`
--
ALTER TABLE `danh_gia`
  ADD CONSTRAINT `nguoidung_danhgia` FOREIGN KEY (`id_nguoidung`) REFERENCES `nguoi_dung` (`id`),
  ADD CONSTRAINT `sanpham_danhgia` FOREIGN KEY (`id_sanpham`) REFERENCES `san_pham` (`id`);

--
-- Các ràng buộc cho bảng `diachi_nguoidung`
--
ALTER TABLE `diachi_nguoidung`
  ADD CONSTRAINT `nguoidung_diachi` FOREIGN KEY (`id_nguoidung`) REFERENCES `nguoi_dung` (`id`);

--
-- Các ràng buộc cho bảng `dieukien_khuyenmai`
--
ALTER TABLE `dieukien_khuyenmai`
  ADD CONSTRAINT `dieukien_khuyenmai` FOREIGN KEY (`id_khuyenmai`) REFERENCES `khuyenmai` (`id`),
  ADD CONSTRAINT `khuyenmai_sanpham` FOREIGN KEY (`id_bienthe`) REFERENCES `bienthe_sp` (`id`);

--
-- Các ràng buộc cho bảng `dieukien_magiamgia`
--
ALTER TABLE `dieukien_magiamgia`
  ADD CONSTRAINT `magiamgia_dieukien` FOREIGN KEY (`id_magiamgia`) REFERENCES `ma_giamgia` (`id`);

--
-- Các ràng buộc cho bảng `don_hang`
--
ALTER TABLE `don_hang`
  ADD CONSTRAINT `magiamgia_donhang` FOREIGN KEY (`id_magiamgia`) REFERENCES `ma_giamgia` (`id`),
  ADD CONSTRAINT `nguoidung_donhang` FOREIGN KEY (`id_nguoidung`) REFERENCES `nguoi_dung` (`id`);

--
-- Các ràng buộc cho bảng `gio_hang`
--
ALTER TABLE `gio_hang`
  ADD CONSTRAINT `nguoidung_giohang` FOREIGN KEY (`id_nguoidung`) REFERENCES `nguoi_dung` (`id`),
  ADD CONSTRAINT `sanpham_giohang` FOREIGN KEY (`id_sanpham`) REFERENCES `san_pham` (`id`);

--
-- Các ràng buộc cho bảng `lichsu_magiamgia`
--
ALTER TABLE `lichsu_magiamgia`
  ADD CONSTRAINT `lichsugiamgia_donhang` FOREIGN KEY (`id_donhang`) REFERENCES `don_hang` (`id`),
  ADD CONSTRAINT `lichsugiamgia_magiamgia` FOREIGN KEY (`id_voucher`) REFERENCES `ma_giamgia` (`id`),
  ADD CONSTRAINT `lichsugiamgia_nguoidung` FOREIGN KEY (`id_user`) REFERENCES `nguoi_dung` (`id`);

--
-- Các ràng buộc cho bảng `nguoi_dung`
--
ALTER TABLE `nguoi_dung`
  ADD CONSTRAINT `uudai_nguoidung` FOREIGN KEY (`id_uudai`) REFERENCES `uudaithanhvien` (`id`);

--
-- Các ràng buộc cho bảng `quatang_khuyenmai`
--
ALTER TABLE `quatang_khuyenmai`
  ADD CONSTRAINT `qtkm_sanpham` FOREIGN KEY (`id_bienthe`) REFERENCES `bienthe_sp` (`id`),
  ADD CONSTRAINT `quatang_khuyenmai` FOREIGN KEY (`id_khuyenmai`) REFERENCES `khuyenmai` (`id`);

--
-- Các ràng buộc cho bảng `sanpham_danhmuc`
--
ALTER TABLE `sanpham_danhmuc`
  ADD CONSTRAINT `danhmuc` FOREIGN KEY (`id_danhmuc`) REFERENCES `danh_muc` (`id`),
  ADD CONSTRAINT `sanpham` FOREIGN KEY (`id_sanpham`) REFERENCES `san_pham` (`id`);

--
-- Các ràng buộc cho bảng `san_pham`
--
ALTER TABLE `san_pham`
  ADD CONSTRAINT `thuonghieu_sanpham` FOREIGN KEY (`id_thuonghieu`) REFERENCES `thuong_hieu` (`id`);

--
-- Các ràng buộc cho bảng `thanh_toan`
--
ALTER TABLE `thanh_toan`
  ADD CONSTRAINT `donhang_thanhtoan` FOREIGN KEY (`id_donhang`) REFERENCES `don_hang` (`id`);

--
-- Các ràng buộc cho bảng `yeu_thich`
--
ALTER TABLE `yeu_thich`
  ADD CONSTRAINT `nguoidung_yeuthich` FOREIGN KEY (`id_nguoidung`) REFERENCES `nguoi_dung` (`id`),
  ADD CONSTRAINT `sanpham_yeuthich` FOREIGN KEY (`id_sanpham`) REFERENCES `san_pham` (`id`);
COMMIT;
