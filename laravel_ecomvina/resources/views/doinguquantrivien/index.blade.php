...
@section('title','Danh sách đội ngủ quản trị | Quản trị hệ thống Siêu Thị Vina')
        ...
        <div class="content">
          <div class="page-header">
            <div class="page-title">
              <h4>Danh sách đội ngủ quản trị</h4>
              <h6>Quản lý thông tin đội ngủ quản trị của bạn.</h6>
            </div>
          </div>
                  ...
                  <tbody>
                    @foreach ($danhsach as $ds)
                      <tr>
                        ...
                        <td>
                          <a class="me-3" href="{{ route('chi-tiet-doi-ngu-quan-tri', ['id' => $ds->id]) }}" title="xem chi tiết">
                              <img src="{{asset('img/icons/eye.svg')}}" alt="img" />
                          </a>
                          <a class="me-3" href="{{ route('chinh-sua-doi-ngu-quan-tri', ['id' => $ds->id]) }}">
