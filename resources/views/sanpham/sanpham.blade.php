              ...
              <tr>
                ...
                <td class="productimgname center-cell" >
                    <a href="{{ url('/') }}" class="product-img">
                        <img
                            src="{{ $sp->hinhanhsanpham->pluck('hinhanh')->first() ?? asset('img/icons/default-image.png') }}"
                        />
                    </a>
                </td>
                <td>"{{ $sp->ten ?? 'Sản phẩm' }}"</td>
                ...
                <td>
                  ...
                  @endphp
                      {!! wordwrap((number_format($giaMin, 0, ',', '.').'đ - '), 30, "\n") !!}   
                  @if($giaMax > $giaMin)
                      {!! wordwrap((number_format($giaMax, 0, ',', '.').'đ'), 15, "\n") !!}
                  @endif
                  @endif
                </td>
                <td>
