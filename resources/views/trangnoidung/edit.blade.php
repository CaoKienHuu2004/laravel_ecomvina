...
@section('title', 'Chỉnh sửa Trang Nội Dung | Quản trị hệ thống Siêu Thị Vina')
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('trangnoidung.update', $trangnoidung->id) }}"
                      method="POST"
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   name="tieude"
                                   class="form-control"
                                   value="{{ old('tieude', $trangnoidung->tieude) }}"
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   class="form-control"
                                   name="slug"
                                   value="{{ old('slug', $trangnoidung->slug) }}">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="trangthai" class="form-select">
                                @foreach ($selectbox_trangthai as $tt)
                                    <option value="{{ $tt }}"
                                        {{ $trangnoidung->trangthai == $tt ? 'selected' : '' }}>
                                        {{ $tt }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-12">
                        ...
                        <img src="{{ $trangnoidung->hinhanh }}"
                             style="width: 180px; height: auto; border-radius:8px; margin-bottom:10px;">
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea id="mota" name="mota" rows="20" class="form-control">
                                {!! old('mota', $trangnoidung->mota) !!}
                            </textarea>
                        </div>
                    </div>
