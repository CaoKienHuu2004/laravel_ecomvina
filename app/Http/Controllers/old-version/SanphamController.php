...
class SanphamController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('old-version/sanpham', compact('sanphams', 'thuonghieus', 'danhmucs'));
    ...
    public function create()
    {
        ...
        return view('old-version/taosanpham', compact('thuonghieus', 'danhmucs', 'loaibienthes'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('old-version/suasanpham', compact('sanpham', 'danhmucs', 'thuonghieus', 'loaibienthes'));
    }
    ...
    public function show($slug,$id)
    {
        ...
        return view('old-version/chitietsanpham', compact('sanpham'));
    }
}
